...
UsersPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-users',template:/*ion-inline-start:"E:\School\CIR3\Projet S-Fit\Application\S-Fit_Application\src\pages\users\users.html"*/'<!--\n\n  Generated template for the UsersPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>Votre profil</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button (click)="closeUsers()">\n\n        <span ion-text color="primary" showWhen="ios">Annuler</span>\n\n        <ion-icon name="md-close" showWhen="android,windows"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-list>\n\n    <ion-item>\n\n      <h2>{{data.nom}}</h2>\n\n      <p>{{data.prenom}}</p>\n\n    </ion-item>\n\n\n\n    <ion-item *ngFor="let item of data[\'items\']">\n\n      {{item.title}}\n\n        <ion-note item-end>\n\n          {{item.note}}\n\n        </ion-note>\n\n    </ion-item>\n\n\n\n</ion-list>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"E:\School\CIR3\Projet S-Fit\Application\S-Fit_Application\src\pages\users\users.html"*/,
    }),
